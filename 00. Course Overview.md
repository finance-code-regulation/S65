...
If an individual takes the Series 65 examination and does not pass, the following waiting
...
economics, business operations and financial accounting. These twenty questions will cover the
following four components:
(1) Basic Economic Concepts 
o Business cycles
o Monetary and fiscal policies
o Global and geopolitical factors (e.g., currency valuation, effects of exchange
...
o Accounting Fundamentals (e.g., audited vs. unaudited financials, cash vs.
accrual accounting)
...
ranges, standard deviation, Alpha, Beta, and Sharpe ratios, correlations)
...
(9) Characteristics of Pooled Investments
o Share classes
o Liquidity
o Tax implications
